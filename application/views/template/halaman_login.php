  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a><b>Login</b></a>
        <br>
        <a href="<?php echo base_url(); ?>">Aplikasi Schedule CAS Berbasis <i>Web</i></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form role="form" method="post" name="Formlogin" id="Formlogin" action="<?php echo base_url('login'); ?>">
          ...
          <div class="form-group has-feedback">
            <input name="username" id="username" type="text" class="form-control" placeholder="Masukan Username">
